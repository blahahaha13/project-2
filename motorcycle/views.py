...
#   f = Motorcycle(name='G 310 R', description='lorem', price=4750, img='../static/images/G_310_R.jpg')
# ]

# heritages = [
#   a = Motorcycle(name='R nineT', description='lorem', price=15495, img='../static/images/R_nineT.jpg'),
#   b = Motorcycle(name='R nineT Pure', description='lorem', price=11995, img='../static/images/R_nineT_Pure.jpg')
#   c = Motorcycle(name='R nineT Racer', description='lorem', price=13545, img='../static/images/R_nineT_Racer.jpg')
#   d = Motorcycle(name='R nineT Scrambler', description='lorem', price=12995, img='../static/images/R_nineT_Scrambler.jpg')
#   e = Motorcycle(name='R ninT Urban G/S', description='lorem', price=12995, img='../static/images/R_nineT_Urban_G:s.jpg')
# ]
